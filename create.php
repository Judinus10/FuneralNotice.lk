...
<body>
    ...
    <!-- Create Funeral Notice Section -->
    <div class="main-body">
        <div class="create-memorial-section">
            <div class="container">
                <div class="create-memorial-header">
                    <h1>Create a Funeral Notice</h1>
                    <p>Honor your loved one with a beautiful online funeral notice. Share their life story, photos, and
                        accept tributes from friends and family.</p>
                </div>
                ...
                <div class="create-memorial-card">
                    ...
                    <form id="memorialForm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label>Date of Passing <span class="required">*</span></label>
                                <input type="date" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="form-hint">You can write about their life, career, family, hobbies, and special
                                memories.</div>
                        </div>
                ...
                <div class="create-memorial-card">
                    ...
                    <div class="photo-upload-container" id="uploadContainer">
                        ...
                        <p>Choose a clear, respectful photo of your loved one. Max file size: 5MB</p>
                    ...
                    <div id="uploadedPhotoContainer" style="display: none;">
                        <div class="uploaded-photo">
                            ...
                            <div class="remove-photo" onclick="removePhoto()">
                                <i class="fas fa-times"></i>
                            </div>
                        </div>
                    </div>

                    <div class="form-hint">Recommended photo size: 500x500 pixels or larger. Square photos work best.
                    </div>
                </div>

                <div class="create-memorial-card">
                    <h2 class="card-title">Tribute Settings</h2>

                    <div class="tribute-settings">
                        <div class="setting-item">
                            <input type="checkbox" id="allowTributes" checked>
                            <label for="allowTributes">Allow friends and family to post tributes</label>
                        </div>

                        <div class="setting-item">
                            <input type="checkbox" id="allowCandles" checked>
                            <label for="allowCandles">Allow virtual candle lighting</label>
                        </div>

                        <div class="setting-item">
                            <input type="checkbox" id="allowPhotos" checked>
                            <label for="allowPhotos">Allow photo uploads by visitors</label>
                        </div>

                        <div class="setting-item">
                            <input type="checkbox" id="moderatePosts" checked>
                            <label for="moderatePosts">Moderate all posts before publishing</label>
                        </div>

                        <div class="setting-item">
                            <input type="checkbox" id="allowDonations">
                            <label for="allowDonations">Allow donations to charity in memory</label>
                        </div>

                        <div class="setting-item">
                            <input type="checkbox" id="showInDirectory" checked>
                            <label for="showInDirectory">Show in public memorial directory</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="create-actions">
                    ...
                    <button type="submit" form="memorialForm" class="submit-btn" onclick="createMemorial(event)">
                        <i class="fas fa-plus-circle"></i> Create Funeral Notice
                    </button>
                </div>
            </div>
        </div>
