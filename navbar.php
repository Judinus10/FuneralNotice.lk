...
<!-- Mobile App Header (Shows only on mobile) -->
<div class="mobile-app-header">
    <div class="container">
        ...
        <div class="mobile-header-right">
            ...
            <div class="mobile-language-selector" id="mobileLanguageSelector">
                <i class="fas fa-globe"></i>
                <span>EN</span>
            </div>
            ...
            <div class="header-container">
                ...
                <div class="header-actions">
                    <div class="search-box hide-on-mobile">
                        <i class="fas fa-search"></i>
                        <input type="text" placeholder="Search a person..." id="desktopSearchInput">
                    </div>
    ...
    <div class="mobile-search-container" id="mobileSearchContainer">
        <div class="container">
            <div class="mobile-search-box">
                <i class="fas fa-search"></i>
                <input type="text" placeholder="Search a person..." id="mobileSearchInput">
            </div>
        </div>
    </div>
</header>
...
<div class="mobile-menu-container" id="mobileMenuContainer">
    <div class="mobile-menu-header">
        <div class="mobile-menu-title">
            <h3><i class="fas fa-compass"></i> Menu</h3>
        </div>
    ...
    <div class="mobile-menu-content">
        ...
        <div class="advertise-cta">
            <p>Want to advertise here?</p>
            <a href="https://wa.me/94754727075" target="_blank" class="advertise-btn">
                <i class="fab fa-whatsapp"></i> Contact for Ads
            </a>
        </div>
    </div>
</div>
